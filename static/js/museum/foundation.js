...
const DOM = {
    ...
    saveSystemInstructionsBtn: document.getElementById('save-system-instructions-btn'),
    cancelSystemInstructionsBtn: document.getElementById('cancel-system-instructions-btn'),
