...
const DOM = {
    ...
    contactsRecalculateTotalsBtn: document.getElementById('contacts-recalculate-totals-btn'),
    ...
    bulkGpsPickModal: document.getElementById('bulk-gps-pick-modal'),
    bulkGpsPickTitle: document.getElementById('bulk-gps-pick-title'),
    bulkGpsPickSkippedNote: document.getElementById('bulk-gps-pick-skipped-note'),
    bulkGpsPickLat: document.getElementById('bulk-gps-pick-lat'),
    bulkGpsPickLng: document.getElementById('bulk-gps-pick-lng'),
    bulkGpsPickMap: document.getElementById('bulk-gps-pick-map'),
    closeBulkGpsPickModalBtn: document.getElementById('close-bulk-gps-pick-modal'),
    bulkGpsPickCancelBtn: document.getElementById('bulk-gps-pick-cancel-btn'),
    bulkGpsPickApplyBtn: document.getElementById('bulk-gps-pick-apply-btn'),
    ...
    emailGalleryContentSearch: document.getElementById('email-gallery-content-search'),
    emailGalleryContentSearchBtn: document.getElementById('email-gallery-content-search-btn'),
    emailGalleryContentSearchClearBtn: document.getElementById('email-gallery-content-search-clear-btn'),
    emailGalleryContentSearchN: document.getElementById('email-gallery-content-search-n'),
    emailGalleryContentSearchHint: document.getElementById('email-gallery-content-search-hint'),
    ...
    newImageGalleryCreatedFrom: document.getElementById('new-image-gallery-created-from'),
    newImageGalleryCreatedTo: document.getElementById('new-image-gallery-created-to'),
    ...
    newImageGalleryNoGps: document.getElementById('new-image-gallery-no-gps'),
    ...
    newImageDetailActionsGrid: document.getElementById('new-image-detail-actions-grid'),
    newImageDetailActionsBottom: document.getElementById('new-image-detail-actions-bottom'),
    newImageDetailFindSimilarBtn: document.getElementById('new-image-detail-find-similar-btn'),
    newImageDetailFindSameTimeBtn: document.getElementById('new-image-detail-find-same-time-btn'),
