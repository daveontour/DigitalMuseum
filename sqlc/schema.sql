...
--   artefact_embeddings USING vec0(embedding float[768], int_ids text)
-- See internal/database/migrate.go (ensureSQLiteVecEmbeddingTables).
...
CREATE TABLE IF NOT EXISTS users (
    ...
    -- Deprecated: replaced by user_openrouter_api_key. Left in place (unused) rather than
    -- risking a SQLite DROP COLUMN migration; do not read/write these from new code.
...
-- Context-window metadata for message_embeddings vec rows.
